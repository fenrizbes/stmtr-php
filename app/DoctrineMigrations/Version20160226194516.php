 ...
 */
class Version20160226194516 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_achievement ADD CONSTRAINT FK_3F68B6644E645A7E FOREIGN KEY (`key`) REFERENCES game_achievement (`key`) ON DELETE CASCADE');
    }
